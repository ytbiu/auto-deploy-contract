...
contract LegacyUpgradesTest is Test {
    ...
    function testTransparent() public {
        ...
        Upgrades.upgradeProxy(
            proxy, "GreeterV2.sol", abi.encodeWithSelector(GreeterV2.resetGreeting.selector), msg.sender
        );
        address implAddressV2 = Upgrades.getImplementationAddress(proxy);
    ...
    function testUpgradeProxyWithoutCaller() public {
        ...
        Upgrades.upgradeProxy(
            proxy, "GreeterV2Proxiable.sol", abi.encodeWithSelector(GreeterV2Proxiable.resetGreeting.selector)
        );
        vm.stopPrank();
    }
