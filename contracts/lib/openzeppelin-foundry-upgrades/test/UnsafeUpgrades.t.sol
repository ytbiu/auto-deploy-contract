...
contract UnsafeUpgradesTest is Test {
    function testUUPS() public {
        address proxy = UnsafeUpgrades.deployUUPSProxy(
            address(new GreeterProxiable()), abi.encodeCall(Greeter.initialize, (msg.sender, "hello"))
        );
        ...
        UnsafeUpgrades.upgradeProxy(
            proxy, address(new GreeterV2Proxiable()), abi.encodeCall(GreeterV2Proxiable.resetGreeting, ()), msg.sender
        );
    ...
    function testTransparent() public {
        address proxy = UnsafeUpgrades.deployTransparentProxy(
            address(new Greeter()), msg.sender, abi.encodeCall(Greeter.initialize, (msg.sender, "hello"))
        );
        Greeter instance = Greeter(proxy);
        address implAddressV1 = UnsafeUpgrades.getImplementationAddress(proxy);
        ...
        UnsafeUpgrades.upgradeProxy(
            proxy, address(new GreeterV2()), abi.encodeCall(GreeterV2.resetGreeting, ()), msg.sender
        );
        address implAddressV2 = UnsafeUpgrades.getImplementationAddress(proxy);
    ...
    function testBeacon() public {
        ...
        address proxy =
            UnsafeUpgrades.deployBeaconProxy(beacon, abi.encodeCall(Greeter.initialize, (msg.sender, "hello")));
        Greeter instance = Greeter(proxy);
    ...
    function testUpgradeProxyWithoutCaller() public {
        address proxy = UnsafeUpgrades.deployUUPSProxy(
            address(new GreeterProxiable()), abi.encodeCall(GreeterProxiable.initialize, (msg.sender, "hello"))
        );

        vm.startPrank(msg.sender);
        UnsafeUpgrades.upgradeProxy(
            proxy, address(new GreeterV2Proxiable()), abi.encodeCall(GreeterV2Proxiable.resetGreeting, ())
        );
        vm.stopPrank();
    }
    ...
    function testWithConstructor() public {
        address proxy = UnsafeUpgrades.deployTransparentProxy(
            address(new WithConstructor(123)), msg.sender, abi.encodeCall(WithConstructor.initialize, (456))
        );
