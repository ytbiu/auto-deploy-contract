...
contract DefenderDeployTest is Test {
    function testBuildDeployCommand() public {
        ...
        string memory commandString =
            StringHelper.join(DefenderDeploy.buildDeployCommand(contractInfo, buildInfoFile, "", opts));
    ...
    function testBuildDeployCommandWithConstructorData() public {
        ...
        DefenderOptions memory opts;
        string memory commandString =
            StringHelper.join(DefenderDeploy.buildDeployCommand(contractInfo, buildInfoFile, constructorData, opts));
    ...
    function testBuildGetApprovalProcessCommand() public view {
        string memory commandString =
            StringHelper.join(DefenderDeploy.buildGetApprovalProcessCommand("getDeployApprovalProcess"));
