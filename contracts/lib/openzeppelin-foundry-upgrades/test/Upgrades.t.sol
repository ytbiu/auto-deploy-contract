...
contract UpgradesTest is Test {
    ...
    function testUUPS() public {
        address proxy =
            Upgrades.deployUUPSProxy("GreeterProxiable.sol", abi.encodeCall(Greeter.initialize, (msg.sender, "hello")));
        ...
        Upgrades.upgradeProxy(
            proxy, "GreeterV2Proxiable.sol", abi.encodeCall(GreeterV2Proxiable.resetGreeting, ()), msg.sender
        );
    ...
    function testTransparent() public {
        address proxy = Upgrades.deployTransparentProxy(
            "Greeter.sol", msg.sender, abi.encodeCall(Greeter.initialize, (msg.sender, "hello"))
        );
        Greeter instance = Greeter(proxy);
        address implAddressV1 = Upgrades.getImplementationAddress(proxy);
    ...
    function testUpgradeProxyWithoutCaller() public {
        address proxy = Upgrades.deployUUPSProxy(
            "GreeterProxiable.sol", abi.encodeCall(GreeterProxiable.initialize, (msg.sender, "hello"))
        );
    ...
    function testWithConstructor() public {
        ...
        address proxy = Upgrades.deployTransparentProxy(
            "WithConstructor.sol:WithConstructor", msg.sender, abi.encodeCall(WithConstructor.initialize, (456)), opts
        );
    ...
    function testProxyAdminCheck_skip() public {
        ...
        Upgrades.deployTransparentProxy(
            "Greeter.sol", address(hasOwner), abi.encodeCall(Greeter.initialize, (msg.sender, "hello")), opts
        );
    }
...
contract Invoker {
    function deployTransparentProxy(string memory contractName, address admin, bytes memory data)
        public
        returns (address)
    {
    ...
    function deployTransparentProxy(string memory contractName, address admin, bytes memory data, Options memory opts)
        public
        returns (address)
    {
